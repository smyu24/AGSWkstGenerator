...
def Evaluating_Variable_Expressions_1(option_difficulty, option_random):
    ...
    while pass_loop != True:
      if option_difficulty == "easy": #(NUM range from 1~10)
          if temp == 1:
  ...
  #---------------------------------------------------------------------------------------------------------
      elif option_difficulty == "medium": #(NUM range from 1~15)
          if temp == 1:
      ...
      elif option_difficulty == "hard": #(NUM range from 5~15)
          if temp == 1:
    ...
    if str(answerset) == "[zoo]":
      ...
      print(str(answerset), answerset[0])
