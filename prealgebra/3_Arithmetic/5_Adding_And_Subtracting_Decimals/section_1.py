...
def Adding_And_Subtracting_Decimals_1(option_difficulty, option_random):
    problemsets = []
    answerset = []
    one = 0
    two = 0
...
a,b = Adding_And_Subtracting_Decimals_1("easy", False)
print(a,b)
a,b = Adding_And_Subtracting_Decimals_1("medium", False)
print(a,b)
a,b = Adding_And_Subtracting_Decimals_1("hard", False)
print(a,b)