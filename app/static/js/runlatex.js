...
runlatex.texts ={
    ...
    "TeXLive.net":      "", // or "run latex" or whatever
    "Delete Output":    "",
    "Compiling PDF":    "",
...
function latexcgi(nd) {
    var fm = document.getElementById('form2-pre0');
    fm.innerHTML="";
    var p = document.getElementById(nd);
    var t = editors[nd].getValue();
    var engv=rldefaultengine;
	...
	ifr.setAttribute("height","850em");
	ifr.setAttribute("id",nd + "ifr");
	ifr.setAttribute("name",nd + "ifr");
	ifr.style.marginLeft = "400px";
	ifr.style.right = "800px";
