...
def Multiplying_Integers_1(option_difficulty, option_random, localmin, localmax):
    problemsets = []
    answerset = []
    to_be_prime = 0
    holder = []
...
def Multiplying_Integers_2(option_difficulty, option_random, localmin, localmax):
    problemsets = []
    answerset = []
    to_be_prime = 0
    holder = []
