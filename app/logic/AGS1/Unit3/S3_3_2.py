...
# no difficulties for this one

""" ERROR FOUND; FIX BEFORE PUSH
   problem, answer = PWChars(randint(3,5), cont=False)
  File "c:\Users\smyu2\OneDrive\GitHub\AGS_Worksheet_Generator\app\logic\AGS1\Unit3\S3_3_2.py", line 35, in PWChars
    func = QuadFunc.from2Pts(1, [endPts[jj],start], [endPts[jj]+step,start+randint(-4,4)])
  File "c:\Users\smyu2\OneDrive\GitHub\AGS_Worksheet_Generator\app\logic\AGS1\loader.py", line 546, in from2Pts
